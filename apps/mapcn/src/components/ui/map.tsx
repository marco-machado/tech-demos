...
// Vendored MIT from AnmolSaini16/mapcn (src/registry/map.tsx) — https://mapcn.dev
// Worker URL uses Vite BASE_URL so /mapcn/ serving can self-host maplibre-gl-worker.mjs.
...
if (typeof window !== "undefined" && !MapLibreGL.getWorkerUrl()) {
  ...
  MapLibreGL.setWorkerUrl(`${prefix}maplibre-gl-worker.mjs`);
}
